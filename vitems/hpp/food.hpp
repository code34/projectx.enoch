    ...
    class redbullcan {
        type[] = {"food"};
        title = "Redbull can";
        description = "Red Bull Energy Drink is a functional beverage especially developed for increased performance.<br/><br/>Drink: <t color='#ff9d00'>+5</t> <br/>Food: <t color='#cc0000'>-10</t>";
        weight = 1;
        nbusage = 1;
